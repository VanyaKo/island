...
public class Consts {
    public static final String EAT_PROBABILITY_CONFIG_JSON = "configs/eat_config.json";
    public static final String MOVE_PROBABILITY_CONFIG_JSON = "configs/move_config.json";
    public static final String REPRODUCE_PROBABILITY_CONFIG_JSON = "configs/reproduce_config.json";
